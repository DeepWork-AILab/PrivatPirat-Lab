...
IP/SSH metadata и REALITY target/SNI не считаются credentials. По отдельному явному решению владельца для конкретного приватного run агент может включать их точные значения в текущий приватный операторский чат и готовую команду; уже предоставленное значение не требуется повторно переносить или вводить вручную. Публичная фиксация этих metadata по-прежнему запрещена без отдельного решения.
